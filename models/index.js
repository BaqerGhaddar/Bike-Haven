...
User.belongsToMany(Bicycle, { through: Wishlist, foreignKey: 'user_id' });
Bicycle.belongsToMany(User, { through: Wishlist, foreignKey: 'bike_id' });
User.belongsToMany(Part, {  through: Wishlist,  foreignKey: 'user_id'});
Part.belongsToMany(User, {  through: Wishlist,  foreignKey: 'part_id'});
